...
public class GmailService {
    ...
    String user = "testmedia0000@gmail.com";
    String pass = "qwertyqwertyQ1";

    private volatile boolean isMessageReceived = false;
    private volatile String messageString;

    public static void main(String[] args) {
        String messageSubjectPartial = "Christian, here's the link to reset your password";
    ...
    public synchronized String waitForNewMessage(String messageSubjectPartial, String messageToPartial, String messageFromPartial, long timeoutInSec) {
        ...
        try {
            ...
            try {
                ...
                throw new AuthenticationFailedException("Make sure 'Allow less secure apps' is 'ON' on gmail account here " + "https://myaccount.google.com/lesssecureapps" + "\n" + e.getMessage());
            }
